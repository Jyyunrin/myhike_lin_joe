...
//Getting user from authentication object
    ...
    .get()   //the collection called "hikes"
        .then(allHikes=> {
            ...
            allHikes.forEach(doc => { //iterate thru each doc
                ...
                //Assigning unique ID to the event icon
                //Attaching an onlick, calling the callback function (with the docID of the hike)
...
// insertNameFromFirestore();
//getting user id from user collection
